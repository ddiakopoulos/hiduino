...
USB_Descriptor_Device_t PROGMEM Serial_DeviceDescriptor =
{
...
Serial_Descriptor_Configuration_t PROGMEM Serial_ConfigurationDescriptor =
{
	.Config =
		{
			.Header                   = {.Size = sizeof(USB_Descriptor_Configuration_Header_t), .Type = DTYPE_Configuration},

			.TotalConfigurationSize   = sizeof(Serial_Descriptor_Configuration_t),
			.TotalInterfaces          = 2,
 ...
 */
USB_Descriptor_String_t PROGMEM Serial_LanguageString =
{
 ...
 *  Descriptor.
 */
USB_Descriptor_String_t PROGMEM Serial_ManufacturerString =
{
 ...
 *  Descriptor.
 */
USB_Descriptor_String_t PROGMEM Serial_ProductString =
{
	.Header                 = {.Size = USB_STRING_LEN(14), .Type = DTYPE_String},

	.UnicodeString          = L"HIDUINO Serial"
};
