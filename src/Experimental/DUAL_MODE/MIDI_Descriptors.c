...
USB_Descriptor_Device_t PROGMEM MIDI_DeviceDescriptor =
{
...
MIDI_Descriptor_Configuration_t PROGMEM MIDI_ConfigurationDescriptor =
{
	.Config =
		{
			.Header                   = {.Size = sizeof(USB_Descriptor_Configuration_Header_t), .Type = DTYPE_Configuration},

			.TotalConfigurationSize   = sizeof(MIDI_Descriptor_Configuration_t),
			.TotalInterfaces          = 2,
	...
	.Audio_StreamInterface_SPC =
		{
			...
			.TotalLength              = (sizeof(MIDI_Descriptor_Configuration_t) -
			                             offsetof(MIDI_Descriptor_Configuration_t, Audio_StreamInterface_SPC))
		},
 ...
 */
USB_Descriptor_String_t PROGMEM MIDI_LanguageString =
{
 ...
 *  Descriptor.
 */
USB_Descriptor_String_t PROGMEM MIDI_ManufacturerString =
{
 ...
 *  Descriptor.
 */
USB_Descriptor_String_t PROGMEM MIDI_ProductString =
{
	.Header                 = {.Size = USB_STRING_LEN(12), .Type = DTYPE_String},

	.UnicodeString          = L"HIDUINO MIDI"
};
